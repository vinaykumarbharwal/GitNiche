...
export default function Filters({
  ...
  const selectClass = 'w-full rounded-md border border-border-color bg-bg-btn px-3 py-2 text-sm text-text-primary outline-none focus:border-[#1f6feb] focus:bg-bg-card focus:ring-2 focus:ring-[#1f6feb]/30 transition';
